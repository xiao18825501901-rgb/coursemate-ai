  ...
  return <div className="page narrow-page">
    ...
    <div className="settings-grid">
      ...
      <section className="settings-panel publication-panel">
        ...
        {course?.publicationStatus === "pending" ? <div className="privacy-notice"><strong>Review pending</strong><span>The course remains private until an administrator approves it.</span><button className="text-button danger-text" onClick={() => void withdrawPublication()} type="button">Withdraw publication request</button></div> : course?.publicationStatus === "published" ? <div className="privacy-notice"><strong>Published course</strong><span>Withdrawal ends future public access and invalidates the current release cache. Copies already lawfully downloaded cannot be recalled.</span><button className="text-button danger-text" onClick={() => void withdrawPublication()} type="button">Withdraw published course</button></div> : <>
