...
export class Learn extends React.Component {
    ...
    async ask(lane, text = null, bridge = null) {
        ...
        try {
            ...
            const result = await send(`/conversations/${id}/runs`, { text: value, request_id: key(), bridge_id: bridge?.id || null, ...frozen });
